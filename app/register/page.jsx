...
const Register = () => {
  ...
  const handleGoogleRegister = async () => {
    try {
      ...
      alert(`Registration Successful for ${user.displayName}`);
    } catch (error) {
    ...
    <div className="flex min-h-[80vh] items-center justify-center p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl border border-slate-100">
        ...
        <div className="relative my-6 text-center">
          ...
          <span className="relative bg-white px-3 text-xs text-slate-500 font-medium uppercase">
            Or register with
          </span>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            type="button"
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-cyan-500/30 bg-cyan-50 py-3 text-sm font-semibold text-slate-900 transition hover:bg-cyan-100 active:scale-[0.99]"
          >
        ...
        <p className="mt-6 text-center text-sm font-bold text-slate-900">
          ...
          <Link
            href="/login"
            className="text-pink-600 hover:underline transition ml-1"
          >
            Login
          </Link>
        </p>
